...
namespace PayrollSystem.UserControls
{
    public partial class EmployeeView : UserControl
    {
        ...
        public EmployeeView(MainForm mainForm, PersonalInformationDisplayDto employeeInfo)
        {
            ...
            Fullname.Text = $"{_employeeInfo.FirstName} {(string.IsNullOrEmpty(_employeeInfo.MiddleName) ? "" : $"{_employeeInfo.MiddleName[0]}. ")}{_employeeInfo.LastName}{(string.IsNullOrEmpty(_employeeInfo.Suffix) ? "" : $" {_employeeInfo.Suffix}")}";
            ...
            ActiveLabel.ForeColor = _employeeInfo.IsActive ? Color.LimeGreen : Color.Red;
