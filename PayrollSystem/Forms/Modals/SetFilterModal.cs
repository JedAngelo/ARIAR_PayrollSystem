...
namespace PayrollSystem.Forms.Modals
{
    public partial class SetFilterModal : Form
    {
        ...
        private readonly EmployeeManagement _parent;

        public SetFilterModal(EmployeeManagement parent)
        {
            InitializeComponent();
            _parent = parent;
        }
        ...
        private async void SetFilterModal_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MaritalViewScrollBar.Maximum = 100;
                MaritalViewScrollBar.LargeChange = 60;
                MaritalViewScrollBar.Value = 0;
                MaritalViewScrollBar.Visible = true;
            }
            catch (Exception ex)
            {
                Console.WriteLine(ex.Message);
