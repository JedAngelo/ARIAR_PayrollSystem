...
namespace PayrollSystem.Forms.Modals
{
    public partial class UpdateAttendanceModal : Form
    {
        ...
        public UpdateAttendanceModal(MainForm mainForm, AttendanceDisplayDto displayDto, string date)
        {
            InitializeComponent();
            _mainForm = mainForm;
        ...
        private async void LoadData(Guid id, string date)
        {
            ...
            await ControlsHelper.ConvertByteToImageAsync(_mainForm.EmployeeInfo.FirstOrDefault(x => x.PersonalId == id).EmployeeImage, EmployeePictureBox);
        }
        ...
        private async void UpdateButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                _attendanceLog.Type = "MANUAL(MODIFIED)";
