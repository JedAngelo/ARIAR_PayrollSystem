...
namespace PayrollSystem.Forms
{
    public partial class EmployeeManagement : Form
    {
        ...
        public EmployeeManagement(MainForm mainForm)
        {
            InitializeComponent();
            _mainForm = mainForm;
        ...
        private async Task PopulateEmployeeTable()
        {
            try
            {
                ...
                if (employeeData.isSuccess)
                {
                    ...
                    EmployeeBiometricsCount.Text = _mainForm.EmployeeInfo.Count(x => x.HasFingerprintRegistered).ToString();
                    FillEmployeeView(_employees);
                }
                else
                {
        ...
        private async void EmployeeInformation_Load(object sender, EventArgs e)
        {
            ...
            CurrentPayrollPeriodLabel.Text = $"{currentWeekStart:MMMM d} - {currentWeekEnd:MMMM d}";
